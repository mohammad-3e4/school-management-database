...
--
-- Table structure for table `max_marks_6`
--

DROP TABLE IF EXISTS `max_marks_6`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `max_marks_6` (
...
--
-- Dumping data for table `max_marks_6`
--

LOCK TABLES `max_marks_6` WRITE;
/*!40000 ALTER TABLE `max_marks_6` DISABLE KEYS */;
INSERT INTO `max_marks_6` VALUES (1,'english',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(2,'math',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(3,'punjabi',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(4,'evs',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(5,'hindi',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(6,'science',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(7,'social_science',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100);
/*!40000 ALTER TABLE `max_marks_6` ENABLE KEYS */;
UNLOCK TABLES;
