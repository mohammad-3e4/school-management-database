...
--
-- Table structure for table `max_marks_4`
--

DROP TABLE IF EXISTS `max_marks_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `max_marks_4` (
...
--
-- Dumping data for table `max_marks_4`
--

LOCK TABLES `max_marks_4` WRITE;
/*!40000 ALTER TABLE `max_marks_4` DISABLE KEYS */;
INSERT INTO `max_marks_4` VALUES (1,'english',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(2,'math',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(3,'punjabi',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(4,'evs',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(5,'hindi',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100);
/*!40000 ALTER TABLE `max_marks_4` ENABLE KEYS */;
UNLOCK TABLES;
