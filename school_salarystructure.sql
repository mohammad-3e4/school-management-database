...
CREATE TABLE `salarystructure` (
  ...
  `extra_allowance` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`structure_id`),
  KEY `sssss_id_idx` (`staff_id`),
  CONSTRAINT `sssss_id` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`staff_id`)
...
INSERT INTO `salarystructure` VALUES (1,1,'60000','6000','6000','6000','500'),(2,2,'500','500','50','50','50'),(3,3,'5000','500','500','500','500');
