...
--
-- Table structure for table `max_marks_1`
--

DROP TABLE IF EXISTS `max_marks_1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `max_marks_1` (
...
--
-- Dumping data for table `max_marks_1`
--

LOCK TABLES `max_marks_1` WRITE;
/*!40000 ALTER TABLE `max_marks_1` DISABLE KEYS */;
INSERT INTO `max_marks_1` VALUES (1,'english',5,5,1,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(2,'math',5,15,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100),(3,'punjabi',5,5,5,5,5,5,20,10,5,5,80,100,5,5,5,5,5,5,20,10,5,5,80,100);
/*!40000 ALTER TABLE `max_marks_1` ENABLE KEYS */;
UNLOCK TABLES;
