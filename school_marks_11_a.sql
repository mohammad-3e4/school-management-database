...
INSERT INTO `marks_11_a` VALUES (1,1023,'hindi',20,70,'A1',90),(2,1023,'english',25,65,'A1',90),(3,1023,'math',45,45,'A1',90),(4,1023,'physics',45,40,'A',85),(NULL,1024,'english',50,20,NULL,0),(NULL,1023,'chemistry',20,20,'D',40);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_11_a` BEFORE UPDATE ON `marks_11_a` FOR EACH ROW BEGIN
    SET NEW.grand_total = NEW.theory_obt+ NEW.practical_obt;
END */;;
DELIMITER ;
